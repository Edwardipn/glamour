				...
				<div class="fullscreen-container fs-gallery">
					<div class="row gallery-holder gallery-grid3cols">
						<div class="col-sm-6 col-lg-4 gallery-post">
							<a href="{{asset('img/amely/amely_730x1095_1.jpg')}}" class="lightbox" title="">
								<img class="img-fluid" src="{{asset('img/amely/amely_730x1095_1.jpg')}}" alt="">
							</a>
						</div>
						<div class="col-sm-6 col-lg-4 gallery-post">
							<a href="{{asset('img/amely/amely_730x1095_2.jpg')}}" class="lightbox" title="">
								<img class="img-fluid" src="{{asset('img/amely/amely_730x1095_2.jpg')}}" alt="">
							</a>
						</div>
						<div class="col-sm-6 col-lg-4 gallery-post">
							<a href="{{asset('img/amely/amely_730x1095_3.jpg')}}" class="lightbox" title="">

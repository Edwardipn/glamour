				...
				<div class="slides">
					<div class="slide active">
						<div class="col port-item-htext">
							<a href="{{asset('img/daimon/daimon_730x1095_1.jpg')}}" class="" title="">
								<img class="img-fluid" src="{{asset('img/daimon/daimon_730x1095_1.jpg')}}" alt="">
							</a>
						</div>
					</div>
					<div class="slide">
						<div class="col port-item-htext">
							<a href="{{asset('img/daimon/daimon_730x1095_2.jpg')}}" class="" title="">
								<img class="img-fluid" src="{{asset('img/daimon/daimon_730x1095_2.jpg')}}" alt="">
							</a>
						</div>
					</div>
				</div>
								...
								<div class="row layout-masonry">
									...
									<div class="col-sm-6 col-lg-3 port-item-masonry control active">
										<div class="port-item-htext">
												<div class="port-img">
													<img src="{{asset('img/daimon/daimon_730x1095_1.jpg')}}" class="img-fluid" alt="Daimon">
												</div>
									...
									<div class="col-sm-6 col-lg-3 port-item-masonry control">
										<div class="port-item-htext">
										<div class="port-img"><img src="{{asset('img/daimon/daimon_730x1095_2.jpg')}}" class="img-fluid" alt="Daimon"></div>

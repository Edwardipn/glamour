...
@include('util.galleries.amely')
@include('util.galleries.daimon')
@include('util.galleries.jane')
@include('util.galleries.lilan')
@include('util.galleries.nicol')
@include('util.galleries.tabata')
@include('util.galleries.vicky')
<!-- /PAGE CONTENT -->
